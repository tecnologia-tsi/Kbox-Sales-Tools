...
import {ValidateSupplierEncoderRequest} from './ValidateSupplierEncoderRequest';
...
export class SupplierEncoderValidator {
  constructor() {
  }

  async run(request: ValidateSupplierEncoderRequest) {
    ...
    return new ValidateSupplierEncoderResponse(cuppliersEncoder);
  }
}
