...
import { CreateProductEncoderRequest } from './CreateProductEncoderRequest';
...
export class ProductEncoderCreator {
  ...
  async run(request: CreateProductEncoderRequest) {
    ...
    return new CreateProductEncoderResponse(productEncoder);
  }
}
